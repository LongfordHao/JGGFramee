...
public abstract class BaseEntity<T> implements Serializable {
	 ...
	 * 办事服务用户
	 */
	protected UserPublic currentUserPublic;
	/**
	 * 当前实体分页对象
	 */
	...
	public void setCurrentUser(UserPublic currentUserPublic) {
	...
	public UserPublic getCurrentUserPublic() {
		if(currentUserPublic == null){
			currentUserPublic = UserUtilsPublic.getUser();
		}
		return currentUserPublic;
	}

	public void setCurrentUserPublic(UserPublic currentUserPublic) {
		this.currentUserPublic = currentUserPublic;
	}
