...
<div class="header">
    ...
    <div class="nav_m">
        ...
        <ul class="nav clearfix">
            ...
            <li class="now"><a href="contact.jsp">联系我们</a></li>
        </ul>
    </div>
</div>
<!--头部-->
...
<div class="scd clearfix">
    ...
    <div class="scd_r">
        ...
        <div class="scd_m">
        	<div class="contact">
            	<div class="ctt_a clearfix">
                	<div class="ctt_al">
                    	<p>联系我们：地址：深圳市前海深港合作区前湾一路1号A栋201室（入驻深圳市前海商务秘书有限公司） </p>
                        <p>联系电话：4009978555  17701583017 （袁）</p>
                        <p>邮箱：ppt5188@sina.cn</p>
                        <p>网址：www.shwtz.com</p>
                    </div>
                    <dl class="ctt_ar clearfix">
                    	<dt><img src="Assets/upload/code.jpg" alt=""/></dt>
                        <dd>扫一扫关注我们</dd>
                    </dl>
                </div>
